...
for target in $(cat $TARGETS); do
    ...
    amass enum -src -active -df $target/DNS/root_domains.txt -config $target/DNS/amass.ini -o $target/DNS/amass_results.txt -dir $target/DNS/amass_dir -brute -norecursive
